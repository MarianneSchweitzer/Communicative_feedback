#!/usr/bin/env python3
"""
Create plots and statistical tests for semantic caregiver alignment
by child utterance grammaticality.

This is the semantic-only version split from the combined semantic/syntactic
alignment analysis script.

It does two complementary things:

1. Transcript-level stats used for the plot:
   - Computes mean semantic alignment per transcript and grammaticality category.
...
DEFAULT_ALIGNMENT_COLUMN = "align_semantic"
DEFAULT_ALIGNMENT_TYPE = "semantic"
...
def get_args():
    parser = argparse.ArgumentParser(
        description=(
            "Analyze semantic caregiver alignment by child utterance "
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="results_semantic_alignment",
